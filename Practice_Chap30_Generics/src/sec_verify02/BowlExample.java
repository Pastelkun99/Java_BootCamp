...
public class BowlExample {
	...
	public static void main(String[] args) {
		...
		b1.setKey("박근혜");
		b1.setValue("대통령");
		System.out.println("타입 파라미터에 <String, String>으로 객체 생성 후 저장값 불러오기");
		...
		b2.setKey("박근혜");
		b2.setValue(65);
		System.out.println("타입 파라미터에 <String, Integer>으로 객체 생성 후 저장값 불러오기");
		System.out.println("이름 : " + b2.getKey());
		System.out.println("나이 : " + b2.getValue());
	}
