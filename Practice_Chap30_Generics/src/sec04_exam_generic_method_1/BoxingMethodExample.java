...
public class BoxingMethodExample {
	...
	public static void main(String[] args) {
		...
		// 하여 아래와 같이 타입을 지정해줘야 한다. 그러면 정해진 타입에 의해서 T가 결정되어진다.
		...
		// <Integer>는 없어도 된다. 컴파일러가 알아서 매개변수를 보고 타입 유추를 한다.
		// 이 방법을 대부분 사용한다. 아울러 박싱이 된다.
		Box<Integer> box2 = Util.boxing(100);
		// Util.<Integer>boxing("홍길동"); 이는 에러가 난다.
