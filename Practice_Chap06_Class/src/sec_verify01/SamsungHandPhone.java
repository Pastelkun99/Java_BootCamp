...
public class SamsungHandPhone {
	...
	public void setmodel(String model) {
		if(model == "Galaxy3" || model == "Galaxy4" || model == "Galaxy5" || model == "Galaxy6" || model == "Galaxy7" || model == "GalaxyNote") {
			this.model = model;
			return;
		}
		else {
	...
	public String toString() {
		String str = this.getcompany() + "회사의 " + this.color + "색상의 " + this.model + "모델이며, 출시일은 " + this.release + "년입니다.";
		return str;
	}
}