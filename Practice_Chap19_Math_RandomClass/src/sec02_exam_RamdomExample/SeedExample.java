package sec02_exam_RamdomExample;
...
public class SeedExample {
	...
	public static void main(String[] args) {
		...
		//Math.random()과 Random클래스의 가장 큰 차이점은 종자값(Seed)를 설정할 수 있는것에 있다.
		...
		System.out.println(" = rand1(항상 다른 값 반환) = ");
		for (int i = 0; i<5; i++) {
