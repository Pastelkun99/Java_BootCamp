...
public class EqualsExample {
	...
	public static void main(String[] args) {
		...
		//2차원 배열 값 복제
		int[][] cloned1 = Arrays.copyOf(original, original.length);		//값에 의한 복사
		...
		cloned2[1] = Arrays.copyOf(original[1], original[1].length);	//1차월 배열 값 복제
		
		System.out.println("배열 번지 비교 : " + original.equals(cloned2));
		System.out.println("original배열 번지 : " + original);
		System.out.println("cloned2 배열 번지 : " + cloned1);
		System.out.println();
