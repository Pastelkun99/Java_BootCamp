...
public class TreeSetExample {
	...
	public static void main(String[] args) {
		...
		// 아래와 같이 추가되었을때 이진트리로 그리면? 어떻게 될까?
		...
		Integer score = null;
		// 가장 낮은 점수 구하기(이진트리의 가장 왼쪽 값)
		score = scores.first();
		System.out.println("가장 낮은 점수 : " + score);
		// 가장 높은 점수 구하기(이진트리의 가장 오른쪽 값)
		score = scores.last();
		System.out.println("가장 높은 점수 : " + score);
		// 주어진 객체의 왼쪽에 있는 점수(95점 아래의 점수) -- 주어진 객체 미포함
		...
		System.out.println();
		// 주어진 객체를 포함하여 바로 위의 점수를 변환 -- 주어진 객체 포함
		...
		/*while(!scores.isEmpty()) {
			// 제일 왼쪽 값 부터 불러온다. 단, 가져온 수 treeset에서 제거가 된다.
		...
		while(iterator.hasNext()) {
			...
			// 가장 큰 차이점이다. 앞에서 말했듯이 명시적으로 remove()를 해줘야 비로소 제거가
			// 됨을 기억하자.
